...
if __name__ == "__main__":
    ...
    df.to_csv("Data/Heat_equation/u_train_Ns={}_sigma={}.csv".format(dim_u, q), index=False)
    ...
    df3.to_csv("Data/Heat_equation/u_test_Ns={}_sigma={}.csv".format(dim_u, q), index=False)
